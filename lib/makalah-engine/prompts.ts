...
export function buildOutlinePrompt(input: MakalahEngineInput): string {
  return [
    ...
    "Sesuaikan struktur dengan jenis tugas dari instruksi dosen. Jangan memakai contoh produk, brand, atau mata kuliah yang tidak diberikan user.",
    "Untuk proposal, susun sebagai proposal akademik dengan konteks, objek/kegiatan, rencana kerja, timeline, evaluasi, dan penutup bila relevan.",
...
export function buildChapterPrompt(
  ...
  return [
    ...
    "Jika tugas adalah proposal, tulis sebagai proposal untuk objek yang diberikan user. Jangan menulis Analisis Instruksi Tugas.",
    "Semua subbab harus terhubung dengan topik, objek, data, dan mata kuliah yang benar-benar diberikan.",
